...
public class Materials {
    ...
    public static final Material SUN = Material.builder().texture(Textures.SUN).ambient(new Vector3f(0.0f, 0.0f, 0.0f)).diffuse(new Vector3f(1f, 1f, 1f)).specular(new Vector3f(1f, 1f, 1f)).shininess(1f).build();
